						...
						<div style={{ marginTop: 6 }}>
							...
							{c.formula && (
								<div style={{ background: '#f0f4f8', borderRadius: 6, padding: '10px 12px', marginBottom: 6, border: '1px solid #e2e8f0' }}>
									...
									{c.formulaVariables && <div style={{ fontSize: 11, color: '#64748b', marginTop: 2 }} dangerouslySetInnerHTML={{ __html: formatVariablesHtml(safeRender(c.formulaVariables)) }} />}
								</div>
							)}
