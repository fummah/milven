...
import { BookOutlined, SearchOutlined, ClockCircleOutlined, ThunderboltOutlined, CalculatorOutlined, MenuOutlined, CloseOutlined, RightOutlined, DownOutlined, AppstoreOutlined, FolderOutlined } from '@ant-design/icons';
						...
						<Row gutter={[16, 16]}>
							{notes.map(n => (
								<Col xs={24} sm={12} lg={8} key={n.id}>
									<Card hoverable style={{ borderRadius: 14, overflow: 'hidden', border: '1px solid #e2e8f0', height: '100%' }} bodyStyle={{ padding: 0 }} onClick={() => { setPreviewNote(n); setPreviewOpen(true); }}>
